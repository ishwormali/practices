...
namespace SampleApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult OpenAuthLogOn()
        {
            var open_id_identifier = "https://www.google.com/accounts/o8/id";
            ...
            {
                Identifier id;
                if (Identifier.TryParse(open_id_identifier,out id))
                {
                    try
                    {
                        var req = openid.CreateRequest(id);
                        var fields = new FetchRequest();
                        fields.Attributes.AddRequired(WellKnownAttributes.Name.FullName);
                        fields.Attributes.AddRequired(WellKnownAttributes.Contact.Email);
                ...
                switch (response.Status)
                {
                    case(AuthenticationStatus.Authenticated):
                        ...
                        FormsAuthenticationTicket ticket = new FormsAuthenticationTicket(1,
                                                                                         claim.GetAttributeValue(WellKnownAttributes.Name.FullName),
                                                                                         DateTime.Now,
